...
def attack(char_name: str, char_class: str) -> str:
    ...
    Функция рассчитывает и возвращает результат атаки
...
def defence(char_name: str, char_class: str) -> str:
    ...
    Функция рассчитывает и возвращает результат защиты
    в зависимости от класса персонажа.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    ...
    Функция уточняет применение персонажем спецумения и возвращает
    его тип, в зависимости от класса персонажа.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    Функция предлагает пользователю провести тренировку персонажа.
    В зависимости от выбора пользователя обращается к функциям
    attack(), defence(), special(), либо пропускает тренировку.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    Функция предлагает пользователю выбрать класс персонажа.
    """
    approve_choice: str = ''
    char_class: str = ''
