...
def start_training(character):
    ...
    training_commands = {'attack': character.attack,
                         'defence': character.defence,
                         'special': character.special}
    
    command_choise: str = None
    
    
    while command_choise != 'skip':
        command_choise = input('Введи команду: ')
        ...
        if command_choise in training_commands:
            print(training_commands[command_choise]())
